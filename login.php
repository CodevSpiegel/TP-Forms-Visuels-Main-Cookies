...
if( isset($_COOKIE["tpdev"]) && $_COOKIE["tpdev"] === "coucou") {
    $msg_perso = "Bon retour parmi nous !";
} else {
    $msg_perso = "Bonjour et bienvenue";
    setcookie("tpdev", "coucou", time() + 20);
}
            ...
            <div class="form_login">
                <form action="statement.php" method="POST">
                    ...
                    <div class="input password">
                        ...
                        <input type="password" name="password" id="password" placeholder="Votre mot de passe" required autocomplete>
